...
class EchoComponent(ComponentXMPP):
    ...
    def message(self, msg):
        ...
        if msg.find('{https://code.moparisthebest.com/moparisthebest/echo-self}echo') is not None:
            to = msg['to']
            msg['to'] = msg['from']
            msg['from'] = to
            ...
            #to = msg['to']
            #ffrom = msg['from']
            #msg = msg.find('{urn:xmpp:forward:0}forwarded')
            #msg['to'] = ffrom
            #msg['from'] = to
...
if __name__ == '__main__':
    ...
    if opts.jid is None or opts.server is None or opts.port is None:
        print("must define jid, server, port and password")
        exit(1)
